    ...
    <el-card class="chat-card">
      <template #header>
        <div class="card-header">
          ...
          <p class="description">Answer your question after retrieving the document</p>
        </div>
      </template>

      <div class="chat-interface">
        <div class="messages-container" ref="messagesContainer">
          <el-empty v-if="messages.length === 0" description="Start asking questions and AI will answer them based on the retrieved documents" />
                  ...
                  <el-collapse-item>
                    ...
                    <div class="documents-list">
                      ...
                      >
                        ...
                        <el-tag v-if="doc.metadata" size="small" type="info">Source: {{ doc.metadata.source || 'Unknown' }}</el-tag>
                      </el-card>
                    </div>
                  </el-collapse-item>
                </el-collapse>
...
async function sendMessage() {
  ...
  try {
    ...
    messages.value.push({
      role: 'assistant',
      content: response.data?.data?.answer || 'Sorry, I can\'t answer this question.',
    ...
    messages.value.push({
      role: 'system',
      content: `Error: ${error.response?.data?.message || error.message || '未知错误'}`
    })
  } finally {
